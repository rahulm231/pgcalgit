 ...
 */
   $config_directories = array(
     CONFIG_SYNC_DIRECTORY => 'sites/default/files/config_acqTmp-2018-12-26T18.03.45-8467',
  );
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_pgcalgit_8a_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_pgcalgit_8a_dd.inc';
}
// </DDSETTINGS>
   $config_directories = array(
     CONFIG_SYNC_DIRECTORY => 'D:/xampp/htdocs/pgcal-d8/sites/default/files/config_acqTmp-2019-01-14T16.44.41-8009',
  );
