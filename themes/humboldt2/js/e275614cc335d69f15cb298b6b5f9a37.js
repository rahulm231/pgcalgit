...
(function ($) {
	jQuery(document).ready(function (){
		...
		var gridLast = $('.col-3:last-child, .col-4:last-child, .col-5:last-child, .col-6:last-child, .col-7:last-child, .col-8:last-child, .col-9:last-child, .coverage-wrap:last-child, .coverage-wrap:nth-child(2n),.attention .col-6:nth-child(3n), .social-wrap:last-child');
		...
		// showing & hiding social media links
		
		$('.facebook-links').hide();
		$('.facebook-toggle').click(function(e) {
			e.preventDefault();
		...
		$('.twitter-links').hide();
		$('.twitter-toggle').click(function(e) {
			e.preventDefault();
			$('.twitter-links').slideToggle('fast');
